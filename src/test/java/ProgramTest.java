...
class ProgramTest {
    ...
    private final String message = "0000010010101011111";
    ...
    void completeInputEncoding_when_input_has_one_letter() {
        assertEquals(message2,Program.encode("AAAAAAAAAAAAAAAAAAAA").getKey());
        assertEquals(frequencies2,Program.encode("AAAAAAAAAAAAAAAAAAAA").getValue());
    }
